...
const Header = () => {
  ...
  return (
    <div className="flex items-center justify-between text-white bg-red-800 px-4 py-3">
      ...
      <div className="flex items-center gap-5">
        ...
        <div
          ...
          className="bg-red-950 w-10 h-10 rounded-full flex items-center justify-center cursor-pointer"
        >
